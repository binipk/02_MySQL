...
INSERT INTO user_foreignkey
(user_no, user_id, user_pwd, user_name, gender, phone, email, grade_code)
VALUES (3, 'user03', 'pass03', '이순신', '남', '010-1234-5678', 'hong123@gmail.com', null);
...
CREATE TABLE IF NOT EXISTS user_foreignkey(
          ...
          FOREIGN KEY (grade_code)
              REFERENCES user_grade(grade_code)
           ON UPDATE SET NULL # 부모 테이블의 gread_code 수정
#          ON DELETE SET NULL # 2. 부모 테이블의 행 삭제
) ENGINE=INNODB;
...
-- 1. 부모 테이블의 gread_code 수정, grade_code INT
UPDATE user_grade
   SET grade_code = 300
 WHERE grade_code = 10;
...
INSERT INTO user_check VALUES (null, '안중근', '남성', 40); -- X
INSERT INTO user_check VALUES (null, '유승제', '남', 18);   -- X
