...
-- 단, 급여를 기준으로 내림차순 출력하세요.
    ...
    */
    SELECT E.EMP_NAME 사원명, J.JOB_NAME 직급명, E.SALARY 급여, E.EMP_NO 사원번호, E.EMAIL 이메일, E.HIRE_DATE 입사일
    FROM EMPLOYEE E
...
--    단, 입사일을 기준으로 오름차순 정렬되도록 출력하세요.
    ...
    /*
        ...
        총 row 수는 24
    */
    SELECT E.EMP_NAME 사원명, E.EMP_NO 주민등록번호, E.PHONE 전화번호, D.DEPT_TITLE 부서명, J.JOB_NAME 직급명
    FROM EMPLOYEE E
