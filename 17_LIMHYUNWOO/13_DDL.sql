...
INSERT INTO tbl_rent VALUES(null,DEFAULT,DEFAULT -- 연월일 시분초 사용할때 default자주 사용
                           ,DEFAULT,DEFAULT, DEFAULT);

SELECT * FROM tbl_rent;

INSERT INTO tbl_rent(contractor_name) VALUES ('유승재');

# AUTO_INCREMENT
-- INSERT시 PK 컬럼에 자동으로 번호를 발생(중복되지않게)시켜 저장 할 수 있다.
