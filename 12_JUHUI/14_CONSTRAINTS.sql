...
--
DROP TABLE IF EXISTS user_foreignkey; -- 해당 내용이 있으면 삭제하겠다.
CREATE TABLE IF NOT EXISTS user_foreignkey( -- 존재하지않으면 생성할게요.
 ...
 FOREIGN KEY (grade_code) -- 테이블 레벨로
...
INSERT INTO user_grade VALUE ( 10,  '일반회원');
INSERT INTO user_grade VALUE ( 20,  '우수회원');
...
INSERT INTO user_check VALUE ( null, '유관순', '여', 26);
