...
CREATE TABLE IF NOT EXISTS user_notnull (
                                            user_no INT NOT NULL UNIQUE, -- not null은 컬럼레벨로만 가능
...
(user_no, user_id, user_pwd, user_name, gender, phone, email)
VALUES
    (1, 'user01', 'pass01', '홍길동', '남', '010-1234-5670', 'hong123@gmail.com');
...
INSERT INTO user_grade (grade_code)
VALUES
    (10),
    (20);
...
(user_no, user_id, user_pwd, user_name, gender, phone, email, grade_code)
VALUES
    (3, 'user03', 'pass03', '이순신', '남', '010-1234-5673', 'hong1233@gmail.com', null);
...
CREATE TABLE IF NOT EXISTS user_check (
  ...
  user_name VARCHAR(255) NOT NULL,
  gender VARCHAR(5) CHECK(gender IN ('남', '여')), # 값으로 남, 여 만 들어올 수 있게
