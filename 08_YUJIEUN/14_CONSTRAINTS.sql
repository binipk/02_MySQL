...
(user_no, user_id, user_pwd, user_name, gender, phone, email)
VALUES
    (3, 'user01', null, '홍길동', '남', '010-1234-5678', 'hong123@gmail.com');
...
(user_no, user_id, user_pwd, user_name, gender, phone, email, grade_code)
VALUES
    (3, 'user01', 'pass01', '이순신', '남', '010-1454-5658', 'lote13@gmail.com', null);
...
-- [HY000][3819] Check constraint 'user_check_chk_1' is violated.
INSERT INTO user_check VALUES (null, '유오동', '남성',18);
